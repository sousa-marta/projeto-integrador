...
<section class="d-flex justify-content-center align-items-center p-3 admin-start-margin">
  <form action="/volunteers" method="post" class="card p-5 col-md-7" enctype="multipart/form-data">
    @csrf
    <div class="row">
      <div class="form-group col-md-8">
        <h4>Cadastrar Novo Voluntário</h4>
      </div>
    ...
    <div class="row">
      ...
      <div class="from-group col-md-6">
        ...
        <input class="form-control" type="file" name="volunteerImg" id="volunteerImg">
      </div>
      ...
      <div class="form-group col-md-6">
        <label for="volunteerCountry">País</label>
          <select class="col-md-12" name="volunteerCountry" id="volunteerCountry" required >
