...
<section class="home-summary">
  <div class="justify-content-around align-itens-center d-flex flex-column">
    ...
    <button type="button" aria-label="Saiba mais sobre a Oppy" class="btn btn-primary align-self-center my-2" onclick="location.href='/about'">Saiba mais</button>
  </div>
</section>
  ...
  <div class="row justify-content-around align-itens-center py-1 home-card-section">
    <article class="col-12 col-md-6 col-lg-4 pb-3">
      <div class="home-card d-flex flex-column align-items-center">
        ...
        <div>
          <a href="/about">
            <h4 class="card-title">Para você?</h4>
          </a>
    ...
    <article class="col-12 col-md-6 col-lg-4 pb-3">
      <div class="home-card d-flex flex-column align-items-center">
        <a href="/courses" class="d-flex justify-content-center">
    ...
    <article class="col-12 col-md-6 col-lg-4 pb-3">
      <div class="home-card d-flex flex-column align-items-center">
        ...
        <div>
          <h4 class="card-title"><a href="/support">Assistências</a></h4>
...
<section class="home-banner-apoie">
  <div class="row justify-content-center align-items-center py-2">
    ...
    <button type="button" aria-label="Clique para saber mais sobre como ajudar como voluntário" class="btn btn-primary col-10 col-sm-5 col-md-5 col-lg-3" onclick="location.href='/contribute'">Seja Voluntário</button>
    <button type="button" aria-label="Clique para saber mais sobre como apoiar como empresa" class="btn btn-primary col-10 col-sm-5 col-md-5 col-lg-3" onclick="location.href='/contribute'">Seja Patrocinador</button>
  </div>
</section>
@endsection