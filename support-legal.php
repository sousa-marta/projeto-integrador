...
<head>
  ...
  <title>Assistencia Jurídica</title>
    ...
    <section class="container p-3">
      <div class="row align-items-center">
        ...
        <div class="col-lg-8 col-md-8 banner-img">
          <h1 class="h1-apoio">Conheça a Assistência Jurídica da Oppy</h1>
        </div>
      </div>
    </section>
    <h3 class="container  text-justify font-italic p-3"> A assessoria jurídica a refugiados e a imigrantes é fundamental devido ao alto grau de desconhecimento da legislação brasileira por parte dessas pessoas e da sociedade em geral.
