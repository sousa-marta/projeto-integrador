...
<body>
  ...
  <main class="d-flex justify-content-center align-items-center p-4 mb-5">
    <form action="" method="post" class="register-volunteer-main card p-5 col-lg-5">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="volunteerName" id="volunteerName" placeholder="Nome da empresa" required>
      </div>
      <div class="form-group">
